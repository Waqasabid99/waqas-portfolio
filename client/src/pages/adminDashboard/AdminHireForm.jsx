...
const AdminHireForm = ({ onClose, onProjectCreated }) => {
  ...
  return (
    <div className="absolute top-[9%] left-0 right-0 z-50 flex items-center justify-center py-4">
      <div className="bg-white rounded-xl max-w-screen max-h-[90vh] overflow-y-auto w-full">
