...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        { icon: FaInstagram, href: 'https://www.freelancer.pk/u/waqasali98', label: 'Freelancer' }
    ];
                ...
                <div className="bg-linear-to-r from-[#1365ff] to-[#0f4fb3] rounded-2xl p-8 mb-12 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <button onClick={() => window.open('mailto:waqasaliabid99@gmail.com')} className="hire-me rounded-full px-8 py-3 bg-white text-[#1365ff] border-2 border-white hover:bg-transparent hover:text-white hover:border-white transition-all duration-300 font-medium flex items-center gap-2">
                                <FaEnvelope className="text-lg" />
                                Get In Touch
                            </button>
                            <button onClick={() => window.open('https://wa.me/+923208703508')} className="whatsapp-me rounded-full px-8 py-3 bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#1365ff] transition-all duration-300 font-medium flex items-center gap-2">
